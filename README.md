...
1. Open *EMU8086, **TASM, or **MASM*.
2. Copy and paste the source code of the program you want to test.
3. Assemble and run.
4. Follow the on-screen prompts to input strings or numbers.
...
- OR any x86 real-mode compatible assembler (e.g., MASM, TASM, DOSBox with DEBUG)

---

## Author

This project is part of an Assembly Language learning module. All three programs are written using only *macros* for educational clarity and compact structure.
